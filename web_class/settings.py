"""
Django settings for web_class project.
...
ALLOWED_HOSTS = ['*', 'udokikedaniel.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'web_class.wsgi.application'
